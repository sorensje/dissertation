...
foreach subj (PARC_sub_2699 PARC_sub_2718 PARC_sub_2726 PARC_sub_2736 PARC_sub_2747 \
	...
	tcsh /Users/Jim/PARC_study/Jim_scripts/dissertation/parametricStudy_paraStim.sh $subj studyParaStim |& tee output.studyParaStim.$subj.txt
	adwarp -apar anat_final.${subj}+tlrc -dpar stats.studyParaStim.${subj}+orig -dxyz 3
