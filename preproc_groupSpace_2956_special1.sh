...
# 
# 	exception: 2956. vol reg to run 1 for runs 1-3, vol reg to run 4 for runs 4-6
# 
# ============
...
set runs_13 = (`count -digits 2 1 3`)
set runs_46 = (`count -digits 2 4 6`)
...
###### vol reg to run 1 for runs 1-3 ####
foreach run ( $runs_13 )
  # register each volume to the base
	3dvolreg -verbose -zpad 1 -base pb01.$subj.r01.tshift+orig'[5]' \
