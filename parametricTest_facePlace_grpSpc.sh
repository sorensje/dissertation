...
if ( $#argv > 1 ) then
	...
	set glm_prefix = test_paraFacePlace_grp
endif
...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                          \
    ...
    -stim_times_AM2 7 stimuli/${subj}_recall_place_stimOnset_parametric_allblocks.txt       \
    'SPMG1'                                                           \
    -stim_label 7 stim_para_Place \
    -stim_times_AM2 8 stimuli/${subj}_recall_face_stimOnset_parametric_allblocks.txt       \
    'SPMG1'                                                           \
    -stim_label 8 stim_para_Face \
