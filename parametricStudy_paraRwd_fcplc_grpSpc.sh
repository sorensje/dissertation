...
if ( $#argv > 1 ) then
	...
	set glm_prefix = studyParaRWD_grpspc_stimFP
endif
...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                          \
    ...
    -stim_times_AM2 7 stimuli/${subj}_encode_hiRwd_stimOnset_parametric_allblocks.txt       \
    'SPMG1'                                                           \
    -stim_label 7 stim_para_hi \
    -stim_times_AM2 8 stimuli/${subj}_encode_loRwd_stimOnset_parametric_allblocks.txt       \
    'SPMG1'                                                           \
    -stim_label 8 stim_para_lo \
    -stim_times 9 stimuli/${subj}_person_encode_allblocks.txt      \
    'BLOCK(6,1)'                                                           \
    -stim_label 9 stim_Place \
    -stim_times 10 stimuli/${subj}_place_encode_allblocks.txt     \
    'BLOCK(6,1)'                                                           \
    -stim_label 10 stim_Face \
	-num_glt 9 \
    ...
    -gltsym 'SYM: stim_Place  +stim_Face'         \
    -glt_label 7 allStim					\
    -gltsym 'SYM: stim_Place  -stim_Face'         \
    -glt_label 8 place-face					\
	-gltsym 'SYM: stim_Face  -stim_Place'         \
    -glt_label 9 face-place					\
